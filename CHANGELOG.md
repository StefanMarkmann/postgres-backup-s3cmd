...
- Update image tag references for the v1.0.3 release
...
[Unreleased]: https://github.com/StefanMarkmann/postgres-backup-s3cmd/compare/v1.0.3...HEAD
[1.0.3]: https://github.com/StefanMarkmann/postgres-backup-s3cmd/compare/v1.0.2...v1.0.3
